  ...
  return (
    <section>
      <div className="page-container">
          ...
          <form dir="rtl" onSubmit={editService}>
            ...
            {allClients && allClients.length > 0 ? (
              <select
                ...
                name="client_id"
                defaultValue={
                  serviceData?.client_id ? serviceData.client_id : ""
                }
                onChange={(e) => {
            ...
            {allEmployees && allEmployees.length > 0 ? (
              ...
              >
                ...
                {allEmployees
                  .filter(
                    (employee) => employee.employee_id !== currentEmployee.id
                  )
                  .map((employee, index) => (
            ...
            >
              ...
              <input
                ...
                defaultChecked={
                  serviceData?.service_payment_status === "unpaid"
                }
                disabled={
            ...
            {formData.service_payment_status === "partially-paid" && (
              <>
                <label htmlFor="service_paid_amount">
            ...
            <input
              ...
              name="created_at"
              defaultValue={
                serviceData ? formatDate(serviceData.created_at) : ""
              }
              onChange={handleChange}
              required
            />
            ...
            <div>
              {subServices?.map(
                (subService: subServicesType, index: number) => (
        ...
        <Link
          to={`/services/${serviceData?.client_id}?mode=view`}
          className="back-btn"
        >
